    ...
    return (
        <div className="space-y-6">
            <div className="flex items-start md:items-center justify-between">
                ...
                <div className="flex flex-col items-start md:flex-row md gap-2" itemScope gap-2>
                    <Button
                        variant={"outline"}
                        onClick={() =>
                                            ...
                                            <div className="flex">
                                                ...
                                                <div>
                                                    <Link
                                                        ...
                                                        className="font-medium hover:text-primary hover:underline transition-colors flex items-center capitalize"
                                                    >
                                                        {task.title}
